//you can only export one thing and that one thing is usually an object - can have as many things you want in them
module.exports = {
    ...
    imageBaseFull: 'http://image.tmdb.org/t/p/original',
   	...
   	discoverLinks: [
    	...
    	{
    		buttonText: 'Top Brad Pitt Movies of 2010',
    	...
    	{
	    	buttonText: 'Will Ferrell\'s Top Grossing Comedies',
